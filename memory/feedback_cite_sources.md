...
Always cite sources (protocol docs, RFC links, references) and rationale inline in code comments when making changes.

**Why:** User wants to understand the provenance of every change and be able to verify against upstream documentation. Code should be self-documenting with respect to specifications.
